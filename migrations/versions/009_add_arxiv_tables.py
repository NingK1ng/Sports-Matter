...
Revision ID: 009_add_arxiv_tables
Revises: 008_add_abstract_zh
...
revision: str = '009_add_arxiv_tables'
down_revision: Union[str, None] = '008_add_abstract_zh'
...
def upgrade() -> None:
    ...
    op.create_index('idx_arxiv_crawl_log_status', 'arxiv_crawl_log', ['status', sa.text('started_at DESC')])
    op.create_index('idx_arxiv_crawl_log_source', 'arxiv_crawl_log', ['source', sa.text('started_at DESC')])
