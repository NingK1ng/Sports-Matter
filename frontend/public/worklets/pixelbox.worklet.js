            ...
            if (pbBorderRadius > 2 && Math.floor(size.height) <= 40) {
                switch (pbBackgroundShadowPosition) {
                    case 'bottom-right':
                        ...
                        ctx.lineTo(size.width - pbBorder / 2, size.height -
                            pbBorder / 2 -
                            pbBackgroundShadowBorder / 2 +
                            pbBackgroundShadowBorder / 4);
                        /* Right Line */
                        ctx.moveTo(size.width -
                            pbBorder -
                            pbBackgroundShadowBorder / 2 +
                            pbBackgroundShadowBorder / 4, pbBorder / 2);
                        ctx.lineTo(size.width -
                            pbBorder -
                            pbBackgroundShadowBorder / 2 +
                            pbBackgroundShadowBorder / 4, size.height - pbBorder / 2);
                        break;
                    case 'bottom-left':
                        /* Bottom Line  */
                        ctx.moveTo(pbBorder / 2, size.height -
                            pbBorder / 2 -
                            pbBackgroundShadowBorder / 2 +
                            pbBackgroundShadowBorder / 4);
                        ctx.lineTo(size.width - pbBorder / 2, size.height -
                            ...
                            pbBackgroundShadowBorder / 4);
                        /* Left Line */
                        ctx.moveTo((buttonGroupFirst || buttonSingle ? pbBorder : 0) +
                            pbBackgroundShadowBorder / 2 -
                            pbBackgroundShadowBorder / 4, pbBorder / 2);
                        ctx.lineTo((buttonGroupFirst || buttonSingle ? pbBorder : 0) +
                            pbBackgroundShadowBorder / 2 -
                            pbBackgroundShadowBorder / 4, size.height - pbBorder / 2);
                        break;
                    case 'top-right':
                        /* top Line  */
                        ctx.moveTo(0, pbBorder / 2 +
                            pbBackgroundShadowBorder / 2 -
                            pbBackgroundShadowBorder / 4);
                        ctx.lineTo(size.width - pbBorder / 2, pbBorder / 2 +
                            pbBackgroundShadowBorder / 2 -
                            pbBackgroundShadowBorder / 4);
                        /* Right Line */
                        ctx.moveTo(size.width -
                ...
                switch (pbBackgroundShadowPosition) {
                    ...
                    case 'bottom-left':
                        ...
                        ctx.lineTo(size.width - pbBorder / 2, size.height -
                            ...
                            pbBackgroundShadowBorder / 4);
                        /* Left Line */
                        ctx.moveTo((buttonGroupFirst || buttonSingle ? pbBorder / 2 : 0) +
                            pbBackgroundShadowBorder / 2 -
                            pbBackgroundShadowBorder / 4, pbBorder / 2);
                        ctx.lineTo((buttonGroupFirst || buttonSingle ? pbBorder / 2 : 0) +
                            pbBackgroundShadowBorder / 2 -
                            pbBackgroundShadowBorder / 4, size.height - pbBorder / 2);
                        break;
                    case 'top-right':
        ...
        if (pbBorderRadius > 0) {
            if (pbBackgroundShadowBorder != 0) {
                ...
                if (pbBorderRadius > 2) {
                    ...
                    for (let i = 1; i <= 4; i++) {
                        ...
                        switch (pbBackgroundShadowPosition) {
                            case 'bottom-right':
                                ctx.fillRect(size.width -
                                    pbBorder / 2 -
                                    (pbBorder * (offsetYR - 1)) / 2 -
                                    pbBackgroundShadowBorder / 2, size.height -
                                    (pbBorder * (rb - offsetXR)) / 2 -
                                    pbBackgroundShadowBorder / 2, pbBackgroundShadowBorder / 2, pbBackgroundShadowBorder / 2);
                                break;
                            case 'bottom-left':
                                ctx.fillRect((pbBorder * offsetYR) / 2, size.height -
                            ...
                            case 'top-right':
                                ctx.fillRect(size.width -
                                    ...
                                    pbBackgroundShadowBorder / 2, (pbBorder * offsetYR) / 2, pbBackgroundShadowBorder / 2, pbBackgroundShadowBorder / 2);
                                break;
                            case 'top-left':
                                ctx.fillRect((pbBorder * (lt - offsetXR)) / 2, (pbBorder * offsetYR) / 2, pbBackgroundShadowBorder / 2, pbBackgroundShadowBorder / 2);
                                break;
                            default:
                                break;
                        }
                    ...
                    for (let i = 1; i <= pbBorderRadius + 1; i++) {
                        switch (pbBackgroundShadowPosition) {
                            case 'bottom-right':
                                ...
                                break;
                            case 'bottom-left':
                                ctx.fillRect((pbBorder * i) / 2, size.height -
                                    (pbBorder * (lb - i + 2)) / 2 -
                                    pbBackgroundShadowBorder / 2, pbBackgroundShadowBorder / 2, pbBackgroundShadowBorder / 2);
                                break;
                            case 'top-right':
                                ctx.fillRect(size.width -
                                    (pbBorder * (rt - i + 2)) / 2 -
                                    pbBackgroundShadowBorder / 2, (pbBorder * i) / 2, pbBackgroundShadowBorder / 2, pbBackgroundShadowBorder / 2);
                                break;
                            case 'top-left':
                                ctx.fillRect((pbBorder * (lt - i + 2)) / 2, (pbBorder * i) / 2, pbBackgroundShadowBorder / 2, pbBackgroundShadowBorder / 2);
                                break;
                            default:
                                break;
                        }
            ...
            if (pbBorderRadius > 2) {
                ...
                for (let i = 0; i < 5; i++) {
                    ...
                    if (lt)
                        ctx.fillRect(ltX, y, pbBorder / 2, pbBorder / 2);
                    if (rt)
                        ctx.fillRect(rtX, y, pbBorder / 2, pbBorder / 2);
                    if (lb)
                        ctx.fillRect(lbX, bottomY, pbBorder / 2, pbBorder / 2);
                    if (rb)
                        ctx.fillRect(rbX, bottomY, pbBorder / 2, pbBorder / 2);
                }
                ctx.fill();
                ...
                for (let i = 1; i <= 5; i++) {
                    // LEFT TOP RADIUS
                    if (lt) {
                        ctx.clearRect(0, 0, (pbBorder * (pbBorderRadius - i + 1)) / 2, (pbBorder * i) / 2);
                    }
                    // RIGHT TOP RADIUS
                    if (rt) {
                        ctx.clearRect(size.width - (pbBorder * (pbBorderRadius - i)) / 2, (pbBorder * i) / 2, size.width, pbBorder / 2);
                    }
                    // LEFT BOTTOM RADIUS
                    if (lb) {
                        ctx.clearRect(0, size.height - (pbBorder * (pbBorderRadius - i + 2)) / 2, (pbBorder * (i - 1)) / 2, size.height - (pbBorder * (pbBorderRadius - i)) / 2);
                    }
                    // RIGHT BOTTOM RADIUS
                    if (rb) {
                        ctx.clearRect(size.width - pbBorder / 2 - (pbBorder * (i - 1)) / 2, size.height - (pbBorder * (pbBorderRadius - i + 1)) / 2, size.width, size.height);
                    }
                }
            }
            else {
                ...
                for (let i = 1; i <= pbBorderRadius; i++) {
                    // LEFT TOP RADIUS
                    if (lt) {
                        ctx.fillRect((pbBorder * (pbBorderRadius - i + 1)) / 2, (pbBorder * i) / 2, pbBorder / 2, pbBorder / 2);
                    }
                    // RIGHT TOP RADIUS
                    if (rt) {
                        ctx.fillRect(size.width - (pbBorder * (pbBorderRadius - i + 2)) / 2, (pbBorder * i) / 2, pbBorder / 2, pbBorder / 2);
                    }
                    // LEFT BOTTOM RADIUS
                    if (lb) {
                        ctx.fillRect((pbBorder * i) / 2, size.height - (pbBorder * (pbBorderRadius - i + 2)) / 2, pbBorder / 2, pbBorder / 2);
                    }
                    // RIGHT BOTTOM RADIUS
                    if (rb) {
                        ctx.fillRect(size.width - pbBorder / 2 - (pbBorder * i) / 2, size.height - (pbBorder * (pbBorderRadius - i + 2)) / 2, pbBorder / 2, pbBorder / 2);
                    }
                }
                ctx.fill();
                // button 圆角边框 - 清理多余背景区块
                for (let i = 0; i <= pbBorderRadius + 1; i++) {
                    // LEFT TOP RADIUS
                    if (lt) {
                        ctx.clearRect(0, 0, (pbBorder * (pbBorderRadius - i + 2)) / 2, (pbBorder * i) / 2);
                    }
                    // RIGHT TOP RADIUS
                    if (rt) {
                        ctx.clearRect(size.width - (pbBorder * (pbBorderRadius - i + 1)) / 2, (pbBorder * i) / 2, size.width, pbBorder / 2);
                    }
                    // LEFT BOTTOM RADIUS
                    if (lb) {
                        ctx.clearRect(0, size.height - (pbBorder * (pbBorderRadius - i + 2)) / 2, (pbBorder * i) / 2, size.height - (pbBorder * (pbBorderRadius - i)) / 2);
                    }
                    // RIGHT BOTTOM RADIUS
                    if (rb) {
                        ctx.clearRect(size.width - pbBorder / 2 - (pbBorder * i) / 2, size.height - (pbBorder * (pbBorderRadius - i + 1)) / 2, size.width, size.height);
                    }
                }
            }
        }
