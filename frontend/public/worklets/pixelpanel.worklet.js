...
export class PixelPanel {
    ...
    paint(ctx, size, props) {
        ...
        ctx.fillRect(size.width - border, cornerSize + halfBorder, borderShadow, size.height - cornerSize * 2 - border);
        ctx.fillRect(cornerSize + border, size.height - cornerSize - borderShadow / 2, size.width - cornerSize * 2 - border * 2, borderShadow / 2);
        // Clear corners
